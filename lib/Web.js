...
const port = process.env.OPENSHIFT_NODEJS_PORT || process.env.YAPPY_TRELLO_PORT || process.env.PORT || 8080;
const ip = process.env.OPENSHIFT_NODEJS_IP || process.env.YAPPY_TRELLO_IP || process.env.IP || null;
